...
const i18n = {
    ...
    techItems: [
      {
        ...
        desc: "Agent framework \u2014 sessions, tools, resources, streaming",
        tag: "Core",
      },
      {
        name: "pi-ai",
        desc: "Model abstraction \u2014 Anthropic, OpenAI, Google, DeepSeek",
        tag: "AI",
      },
      {
        name: "TypeBox",
        desc: "JSON Schema builder for tool parameter definitions",
        tag: "Schema",
      },
      {
        name: "TypeScript",
        desc: "Strict mode, ESM, top-level await",
        tag: "Language",
      },
      {
        name: "Bun + tsx",
        desc: "Fast runtime and TypeScript execution",
        tag: "Runtime",
      },
      {
        name: "JSONL Sessions",
        desc: "Line-delimited JSON for persistent conversation storage",
        tag: "Storage",
      },
    ],
  },
  zh: {
    ...
    techItems: [
      {
        name: "pi-coding-agent",
        desc: "Agent 框架 \u2014 会话、工具、资源、流式输出",
        tag: "核心",
      },
      {
        name: "pi-ai",
        desc: "模型抽象层 \u2014 Anthropic、OpenAI、Google、DeepSeek",
        tag: "AI",
      },
      {
        name: "TypeBox",
        desc: "用于工具参数定义的 JSON Schema 构建器",
        tag: "Schema",
      },
      { name: "TypeScript", desc: "严格模式、ESM、顶层 await", tag: "语言" },
      {
        name: "Bun + tsx",
        desc: "高性能运行时和 TypeScript 执行器",
        tag: "运行时",
      },
      {
        name: "JSONL Sessions",
        desc: "行分隔 JSON 格式的持久化对话存储",
        tag: "存储",
      },
    ],
  },
          ...
          <div
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow =
                "0 2px 12px var(--rp-c-brand-tint)";
            }}
            onMouseLeave={(e) => {
...
const FrameworkComparison = () => {
  ...
  return (
    <section
      style={{ maxWidth: 1152, margin: "0 auto", padding: "0 24px 64px" }}
    >
      <h2
        style={{
          textAlign: "center",
                ...
                {featureValues[i].map((v, j) => (
                  <td
                    ...
                    style={{
                      ...
                      padding: "11px 10px",
                      fontSize: 15,
                      background: frameworks[j].highlight
                        ? "var(--rp-c-brand-tint)"
                        : "transparent",
                      color:
                        v === true
      ...
      >
        {"\u2705"} {t.comparison.supported} &nbsp;&nbsp; {"\u{1F7E1}"}{" "}
        {t.comparison.partial} &nbsp;&nbsp; {"\u2014"} {t.comparison.notBuiltIn}
      </p>
    </section>
  );
};
...
const concepts: { name: string; covered: boolean[] }[] = [
  {
    ...
    covered: [true, true, true, true, true, true, true, true],
  },
  {
    name: "Streaming / Events",
    covered: [false, true, true, false, false, true, false, true],
  },
  {
    name: "Custom Tools",
    covered: [false, false, true, false, true, true, false, true],
  },
  {
    name: "Session Persistence",
    covered: [false, false, false, true, false, false, true, true],
  },
  {
    name: "Confirmation Pattern",
    covered: [false, false, false, false, true, false, false, true],
  },
  {
    name: "System Prompt",
    covered: [false, false, false, false, false, true, false, true],
  },
  {
    name: "Skills Loading",
    covered: [false, false, false, false, false, true, false, true],
  ...
  {
    name: "Multi-Session",
    covered: [false, false, false, false, false, false, true, true],
  },
  {
    name: "Coding Tools",
    covered: [false, false, false, false, false, false, false, true],
  },
  {
    name: "Abort / DeltaBatcher",
    covered: [false, false, false, false, false, false, false, true],
  },
];
